            ...
            <main className="bg-background1 w-screen bg-cover">
                <div className="w-full h-full bg-gradient-to-tl from-app-blue-200/90 to-red-700/60 py-10">
                    ...
                    <Slide direction="left">
                        <section className='flex flex-row-reverse rounded-lg w-2/3 mx-auto py-10 mt-16 bg-white'>
                            <div className='w-2/5 pt-20'>
                                <img src={logo} alt="" />
                            </div>
                            <div className='w-3/5 pt-2 px-3 pl-5 text-slate-800'>
                    ...
                    <Slide direction="down">
                        <section className='flex justify-around rounded-lg w-2/3 mx-auto py-10 mt-10 bg-white'>
                            ...
                            <div className="text-center w-[45%] text-slate-800">
                                <div className="text-blue-800 mb-4">
                    ...
                    <Slide direction="left">
                        <section className='rounded-lg w-2/3 mx-auto p-10 mt-10 bg-white'>
                            <h2 className='text-4xl text-app-blue-200 font-semibold mb-2'>
                                Why Us
                            </h2>
                            <hr className='h-2 w-20 bg-red-700 rounded-lg mb-5 border-none' />
                            <ul className="ml-16 mt-10 text-slate-800">
                                <li className="flex gap-2">
                                    <span><CaretDoubleRight size={24} className="text-red-700" /></span>
                                    <span>
                    ...
                    <section className="w-[90%] mx-auto glass rounded-xl mt-10">
                        <div className="w-full h-full bg-gradient-to-l rounded-xl from-app-blue-200/50 to-red-700/30 pt-10">
                            <Slide direction="up">
